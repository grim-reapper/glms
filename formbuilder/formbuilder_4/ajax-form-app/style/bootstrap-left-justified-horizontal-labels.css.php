...
#<?php echo $form_id; ?>_wrap { position: relative; background-color: white; text-align:left; line-height:normal; margin-bottom: 20px; margin-left: auto; margin-right: auto; font-family: "Helvetica Neue", Helvetica, Arial, sans-serif !important; font-size: 12px !important; padding: 10px; border: 0px none !important; color:black !important; }
...
#<?php echo $form_id; ?>_afb_fields .label_zone { text-align:right; float:left; min-width:120px; margin: -2px 0 0; }
...
/* Label */
#<?php echo $form_id; ?>_afb_fields label { font-weight: normal !important; margin: 8px 14px 8px 0 !important; padding-left: 0 !important; text-align: right !important; }
#<?php echo $form_id; ?>_afb_fields label.escts { display:inline; width: auto !important; padding-left: 0px !important; margin: 8px 19px 8px 1px !important; text-align: right !important; float: none !important; font-weight:normal !important; }
...
/* Checkbox */
#<?php echo $form_id; ?>_afb_fields input.chck { float:left; cursor: pointer;  margin: 1px 1px 0 0 !important; padding: 2px !important; background-color:#FEFEFE !important; }
...
#<?php echo $form_id; ?>_afb_fields div.afb_error { float: none !important; clear:both; color:red; font-style:normal; margin:0 0 6px 0; text-align: left; font-size: 13px; }
