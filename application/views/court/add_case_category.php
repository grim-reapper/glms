...
echo form_open('court/add_case_category', $attributes);
?>

<fieldset>
    <div class="widget first_form">
        <div class="head">
            <h5 class="iList">Add Case Category</h5>
        </div>
        ...
        <div class="rowElem noborder">
            ...
            <label>Enter new Case Category</label>
            <div class="formRight">
                <input type="text" name="case_category" value="" />
                </div>
            <div class="clear"></div>
            </div>
        <div class="rowElem">
