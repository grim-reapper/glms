...
echo form_open('decided_cases/update_file', $attributes);
?>
<!-- Input text fields -->
           ...
           <div class="formRight" style="width: 140px;" >
                <select name="fate_case" id="" >
                   ...
                   <?php foreach ($fate_case as $list) {
                       if($list->fate_case_id == $case->fate_case_id){
                           ?>
                    <option value="<?php echo $list->fate_case_id;?>" selected="selected"><?php echo $list->fate_case_name;?></option>
                   <?php } else {?>
